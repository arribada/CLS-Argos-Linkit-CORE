...
#define STC3117_OK                            INT8_C(0)
#define STC3117_E_NULL_PTR                    INT8_C(-1)
#define STC3117_E_COM_FAIL                    INT8_C(-2)
#define STC3117_E_DEV_NOT_FOUND               INT8_C(-3)
#define STC3117_E_OUT_OF_RANGE                INT8_C(-4)
#define STC3117_E_INVALID_INPUT               INT8_C(-5)
/* ******************************************************************************** */
