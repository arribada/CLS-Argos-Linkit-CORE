...
{
	std::string s;
	ParamValue p = { ParamID::DLOC_ARG_NOM, BaseAqPeriod::AQPERIOD_10_MINS };
	std::vector<ParamValue> v = { p };
	s = DTEEncoder::encode(DTECommand::PARMR_RESP, v);
	STRCMP_EQUAL("$O;PARMR#007;ARP11=1\r", s.c_str());
	p = { ParamID::DLOC_ARG_NOM, BaseAqPeriod::AQPERIOD_15_MINS };
	v = { p };
	s = DTEEncoder::encode(DTECommand::PARMR_RESP, v);
	STRCMP_EQUAL("$O;PARMR#007;ARP11=2\r", s.c_str());
	p = { ParamID::DLOC_ARG_NOM, BaseAqPeriod::AQPERIOD_30_MINS };
	v = { p };
	s = DTEEncoder::encode(DTECommand::PARMR_RESP, v);
	STRCMP_EQUAL("$O;PARMR#007;ARP11=3\r", s.c_str());
	p = { ParamID::DLOC_ARG_NOM, BaseAqPeriod::AQPERIOD_60_MINS };
	v = { p };
	s = DTEEncoder::encode(DTECommand::PARMR_RESP, v);
	STRCMP_EQUAL("$O;PARMR#007;ARP11=4\r", s.c_str());
	p = { ParamID::DLOC_ARG_NOM, BaseAqPeriod::AQPERIOD_120_MINS };
	v = { p };
	s = DTEEncoder::encode(DTECommand::PARMR_RESP, v);
	STRCMP_EQUAL("$O;PARMR#007;ARP11=5\r", s.c_str());
	p = { ParamID::DLOC_ARG_NOM, BaseAqPeriod::AQPERIOD_360_MINS };
	v = { p };
	s = DTEEncoder::encode(DTECommand::PARMR_RESP, v);
	STRCMP_EQUAL("$O;PARMR#007;ARP11=6\r", s.c_str());
	p = { ParamID::DLOC_ARG_NOM, BaseAqPeriod::AQPERIOD_720_MINS };
	v = { p };
	s = DTEEncoder::encode(DTECommand::PARMR_RESP, v);
	STRCMP_EQUAL("$O;PARMR#007;ARP11=7\r", s.c_str());
	p = { ParamID::DLOC_ARG_NOM, BaseAqPeriod::AQPERIOD_1440_MINS };
	v = { p };
	s = DTEEncoder::encode(DTECommand::PARMR_RESP, v);
...
{
	std::string s;
	ParamValue p = { ParamID::DLOC_ARG_LB, BaseAqPeriod::AQPERIOD_10_MINS };
	std::vector<ParamValue> v = { p };
	s = DTEEncoder::encode(DTECommand::PARMR_RESP, v);
	STRCMP_EQUAL("$O;PARMR#007;ARP12=1\r", s.c_str());
	p = { ParamID::DLOC_ARG_LB, BaseAqPeriod::AQPERIOD_15_MINS };
	v = { p };
	s = DTEEncoder::encode(DTECommand::PARMR_RESP, v);
	STRCMP_EQUAL("$O;PARMR#007;ARP12=2\r", s.c_str());
	p = { ParamID::DLOC_ARG_LB, BaseAqPeriod::AQPERIOD_30_MINS };
	v = { p };
	s = DTEEncoder::encode(DTECommand::PARMR_RESP, v);
	STRCMP_EQUAL("$O;PARMR#007;ARP12=3\r", s.c_str());
	p = { ParamID::DLOC_ARG_LB, BaseAqPeriod::AQPERIOD_60_MINS };
	v = { p };
	s = DTEEncoder::encode(DTECommand::PARMR_RESP, v);
	STRCMP_EQUAL("$O;PARMR#007;ARP12=4\r", s.c_str());
	p = { ParamID::DLOC_ARG_LB, BaseAqPeriod::AQPERIOD_120_MINS };
	v = { p };
	s = DTEEncoder::encode(DTECommand::PARMR_RESP, v);
	STRCMP_EQUAL("$O;PARMR#007;ARP12=5\r", s.c_str());
	p = { ParamID::DLOC_ARG_LB, BaseAqPeriod::AQPERIOD_360_MINS };
	v = { p };
	s = DTEEncoder::encode(DTECommand::PARMR_RESP, v);
	STRCMP_EQUAL("$O;PARMR#007;ARP12=6\r", s.c_str());
	p = { ParamID::DLOC_ARG_LB, BaseAqPeriod::AQPERIOD_720_MINS };
	v = { p };
	s = DTEEncoder::encode(DTECommand::PARMR_RESP, v);
	STRCMP_EQUAL("$O;PARMR#007;ARP12=7\r", s.c_str());
	p = { ParamID::DLOC_ARG_LB, BaseAqPeriod::AQPERIOD_1440_MINS };
	v = { p };
	s = DTEEncoder::encode(DTECommand::PARMR_RESP, v);
