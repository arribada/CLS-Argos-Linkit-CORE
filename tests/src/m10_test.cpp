...
TEST(M10, FailedToSyncCommsError)
{
    M10QAsyncReceiver m;
...
TEST(M10, FailedToChangeBaudRate)
{
    M10QAsyncReceiver m;
    TestGNSSListener listener(m);
    GPSNavSettings settings;
...
TEST(M10, PVTReportAfterPowerOffDemand)
{
    M10QAsyncReceiver m;
    TestGNSSListener listener(m);
    GPSNavSettings settings;
...
TEST(M10, PVTReportSuccessWithoutANO)
{
    M10QAsyncReceiver m;
    TestGNSSListener listener(m);
    GPSNavSettings settings;
...
TEST(M10, PVTReportSuccessWithANO)
{
    M10QAsyncReceiver m;
    TestGNSSListener listener(m);
    GPSNavSettings settings;
...
TEST(M10, PVTReportSuccessWithANOMissingDBDAck)
{
    M10QAsyncReceiver m;
    TestGNSSListener listener(m);
    GPSNavSettings settings;
...
TEST(M10, PVTReportSuccessWithANOMissingDBDs)
{
    M10QAsyncReceiver m;
    TestGNSSListener listener(m);
    GPSNavSettings settings;
...
TEST(M10, PVTReportSuccessWithANOAndStartNewReceive)
{
    M10QAsyncReceiver m;
    TestGNSSListener listener(m);
    GPSNavSettings settings;
...
TEST(M10, UartCommsErrorDuringReceive)
{
    M10QAsyncReceiver m;
    TestGNSSListener listener(m);
    GPSNavSettings settings;
...
TEST(M10, UartCommsErrorDuringConfig)
{
    M10QAsyncReceiver m;
    TestGNSSListener listener(m);
    GPSNavSettings settings;
...
TEST(M10, UartCommsErrorDuringConfigAndRecover)
{
    M10QAsyncReceiver m;
    TestGNSSListener listener(m);
    GPSNavSettings settings;
...
TEST(M10, PVTReportSuccessWithMGAOverflow)
{
    M10QAsyncReceiver m;
    TestGNSSListener listener(m);
    GPSNavSettings settings;
