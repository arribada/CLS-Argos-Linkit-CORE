...
TEST(DTEHandler, PARML_REQ)
{
	...
	STRCMP_EQUAL("$O;PARML#143;IDP12,IDT06,IDT02,IDT03,ART01,ART02,POT03,POT05,IDP11,ART03,ARP03,ARP04,ARP05,ARP01,ARP19,ARP18,GNP01,ARP11,ARP16,GNP02,GNP03,GNP05,UNP01,UNP02,UNP03,LBP01,LBP02,LBP03,ARP06,LBP04,LBP05,LBP06,ARP12,LBP07,LBP08,LBP09,UNP04,PPP01,PPP02,PPP03,PPP04,PPP05,PPP06,GNP09,GNP10,GNP11,GNP20,GNP21,GNP22,GNP23,ARP30,LDP01,ARP31,GNP24\r", resp.c_str());
}
...
TEST(DTEHandler, STATR_REQ_CheckEmptyRequest)
{
	...
	CHECK_TRUE(DTEAction::NONE == dte_handler->handle_dte_message(req, resp));
	STRCMP_EQUAL("$O;STATR#081;IDT06=0,IDT02=SURFACEBOX,IDT03=V0.1,ART01=01/01/1970 00:00:00,ART02=0,POT03=0,POT05=01/01/1970 00:00:00,ART03=07/10/2021 22:41:14\r", resp.c_str());
}
...
TEST(DTEHandler, PARMR_REQ_CheckEmptyRequest)
{
	...
	CHECK_TRUE(DTEAction::NONE == dte_handler->handle_dte_message(req, resp));
	STRCMP_EQUAL("$O;PARMR#18D;IDP12=0,IDP11=FACTORY,ARP03=300,ARP04=4,ARP05=60,ARP01=2,ARP19=0,ARP18=0,GNP01=1,ARP11=1,ARP16=10,GNP02=1,GNP03=2,GNP05=120,UNP01=0,UNP02=1,UNP03=1,LBP01=0,LBP02=10,LBP03=4,ARP06=240,LBP04=2,LBP05=0,LBP06=1,ARP12=4,LBP07=15,LBP08=1,LBP09=120,UNP04=1,PPP01=5,PPP02=90,PPP03=30,PPP04=1000,PPP05=300,PPP06=10,GNP09=530,GNP10=3,GNP11=0,GNP20=1,GNP21=50,GNP22=1,GNP23=60,ARP30=1,LDP01=1,ARP31=1,GNP24=0\r", resp.c_str());
}
