...
TEST(DTEHandler, PARML_REQ)
{
	...
	STRCMP_EQUAL("$O;PARML#0DD;IDT06,IDT07,IDT02,IDT03,ART01,ART02,POT03,POT05,IDP11,ART03,ARP03,ARP04,ARP05,ARP01,ARP19,ARP18,GNP01,ARP11,ARP16,GNP02,GNP03,GNP05,UNP01,UNP02,UNP03,LOP01,LOP02,LOP03,ARP06,LOP04,LOP05,LOP06,ARP12,LOP07,LOP08,LOP09,UNP04\r", resp.c_str());
}

TEST(DTEHandler, PARMW_REQ)
{
	std::string resp;
	std::string req = "$PARMW#007;ARP04=3\r";
	CHECK_TRUE(DTEAction::NONE == DTEHandler::handle_dte_message(req, resp));
...
{
	std::string resp;
	std::string req = "$PARMR#0D7;IDT06,IDT07,IDT02,IDT03,ART01,ART02,POT03,POT05,IDP11,ART03,ARP03,ARP04,ARP05,ARP01,ARP19,ARP18,GNP01,ARP11,ARP16,GNP02,GNP03,GNP05,UNP01,UNP02,UNP03,LOP01,LOP02,LOP03,ARP06,LOP04,LOP05,LOP06,ARP12,LOP07,LOP08,LOP09\r";
	CHECK_TRUE(DTEAction::NONE == DTEHandler::handle_dte_message(req, resp));
	STRCMP_EQUAL("$O;PARMR#17A;IDT06=0,IDT07=0,IDT02=GenTracker,IDT03=V0.1,ART01=Thu Jan  1 00:00:00 1970,ART02=0,POT03=0,POT05=Thu Jan  1 00:00:00 1970,IDP11=,ART03=Thu Jan  1 00:00:00 1970,ARP03=399.91,ARP04=3,ARP05=45,ARP01=0,ARP19=1,ARP18=0,GNP01=0,ARP11=10,ARP16=1,GNP02=0,GNP03=2,GNP05=60,UNP01=0,UNP02=1,UNP03=1,LOP01=0,LOP02=0,LOP03=3,ARP06=45,LOP04=0,LOP05=0,LOP06=0,ARP12=60,LOP07=2,LOP08=1,LOP09=60\r", resp.c_str());
}

TEST(DTEHandler, STATR_REQ)
{
	std::string resp;
	std::string req = "$STATR#0D7;IDT06,IDT07,IDT02,IDT03,ART01,ART02,POT03,POT05,IDP11,ART03,ARP03,ARP04,ARP05,ARP01,ARP19,ARP18,GNP01,ARP11,ARP16,GNP02,GNP03,GNP05,UNP01,UNP02,UNP03,LOP01,LOP02,LOP03,ARP06,LOP04,LOP05,LOP06,ARP12,LOP07,LOP08,LOP09\r";
	CHECK_TRUE(DTEAction::NONE == DTEHandler::handle_dte_message(req, resp));
	STRCMP_EQUAL("$O;STATR#17A;IDT06=0,IDT07=0,IDT02=GenTracker,IDT03=V0.1,ART01=Thu Jan  1 00:00:00 1970,ART02=0,POT03=0,POT05=Thu Jan  1 00:00:00 1970,IDP11=,ART03=Thu Jan  1 00:00:00 1970,ARP03=399.91,ARP04=3,ARP05=45,ARP01=0,ARP19=1,ARP18=0,GNP01=0,ARP11=10,ARP16=1,GNP02=0,GNP03=2,GNP05=60,UNP01=0,UNP02=1,UNP03=1,LOP01=0,LOP02=0,LOP03=3,ARP06=45,LOP04=0,LOP05=0,LOP06=0,ARP12=60,LOP07=2,LOP08=1,LOP09=60\r", resp.c_str());
}
...
TEST(DTEHandler, PARMR_REQ_CheckEmptyRequest)
{
	...
	CHECK_TRUE(DTEAction::NONE == DTEHandler::handle_dte_message(req, resp));
	STRCMP_EQUAL("$O;PARMR#0E9;IDP11=,ARP03=399.91,ARP04=3,ARP05=45,ARP01=0,ARP19=1,ARP18=0,GNP01=0,ARP11=10,ARP16=1,GNP02=0,GNP03=2,GNP05=60,UNP01=0,UNP02=1,UNP03=1,LOP01=0,LOP02=0,LOP03=3,ARP06=45,LOP04=0,LOP05=0,LOP06=0,ARP12=60,LOP07=2,LOP08=1,LOP09=60,UNP04=1\r", resp.c_str());
}
